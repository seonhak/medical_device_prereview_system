...
import os
import re
from read_to_pdf_pfu import *
def find_pdf_files_with_keyword(folder_path, keyword="사용시주의사항"):
    """
    ...
    keyword_pattern = r'[ \s_.\-]*'.join(keyword)  
...
if __name__ == "__main__":
    pdf_files = find_pdf_files_with_keyword(folder_path, keyword="사용시주의사항")
    ...
    if not pdf_files:
        ...
        for pdf_file in pdf_files:
            ...
            read_pdf_with_pdfplumber_self_adhesive_bandage1(pdf_file)
