...
import os
import re
from read_to_pdf_size import *
def find_pdf_files_with_keyword(folder_path, keyword="치수"):
    """
...
if __name__ == "__main__":
    pdf_files = find_pdf_files_with_keyword(folder_path, keyword="치수")
    ...
    if not pdf_files:
        ...
        for pdf_file in pdf_files:
            ...
            validate_pdf_with_fixed_header(pdf_file, fixed_header, forbidden_words)
