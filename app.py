...
# all_tables, error_messages = validate_all_docs('./test_folder', 1)
all_tables, error_messages = validate_all_docs(r'C:\Users\USER\Desktop\식약처검증',1)
...
save_list_to_hwp(r"C:\Users\USER\Desktop\식약처검증\report\test1.hwp", error_result)
